...
class AllUsersOrder extends StatefulWidget {
  const AllUsersOrder({Key? key, required this.pharmacyID}) : super(key: key);

  final String pharmacyID;

  @override
  State<AllUsersOrder> createState() => _AllUsersOrderState();
}

int _counter = 0;

class _AllUsersOrderState extends State<AllUsersOrder> {
  @override
                            ...
                            children: [
                              Expanded(
                                child: ListTile(
                                  ...
                                  subtitle: Text(
                                    // pharmacy.name,
                                    'Ordered from  ${i.get('pharmacyName')}',
                                    style: const TextStyle(
                                        fontSize: 12,
                                        fontWeight: FontWeight.bold),
                                  ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Spacer(),
                        Text(
                          '${totalPrice.round() + int.parse(doc[0].get('delvivery'))} IQD',
                          style:
                              Theme.of(context).textTheme.titleLarge?.copyWith(
                                    color: Colors.white,
                                  ),
